...
- (void)viewDidLoad {
    ...
    NSString *titleString = @"This is a long long..........long.......title";
...
- (void)implementNavigationBarScrollingLabelView:(NSString *)title{
    ...
    //左右都有BarButtonItem時，將scrollingLable的長度變短
    self.navigationBarScrollingLabel = [[KWMarqueeScrollingLabelView alloc] initWithFrame:CGRectMake(0,0,200,32)];
